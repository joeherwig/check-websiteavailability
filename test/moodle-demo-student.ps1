...
try {
    ...
    log-json "moodle-admin-student" "logging in to \werbas-ag.com\kundencenter was not successful. Even trying to logoff and re-login failed. Please check URI and Credentials!" "login impossible" "C:\Temp\Check-Websites\log\webaccess-log.json"
