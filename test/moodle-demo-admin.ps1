...
try {
    ...
    log-json "moodle-admin-demo" "logging in to 'moodle-admin-demo' was not successful. Even trying to logoff and re-login failed. Please check URI and Credentials!" "login impossible" "C:\Temp\Check-Websites\log\webaccess-log.json"
